...
public class AutoElementLowerEdge extends TestCase {
    @UiTemplate("AutoElement.ui.xml")
    public interface Binder extends UiBinder<Widget, AutoElementLowerEdge> {
    }
    ...
    public void run() {
        ...
        $(listBox).siblings("div").css("bottom", "0");
    }
}
