...
public class Below extends TestCase {
    @UiTemplate("AboveBelow.ui.xml")
    public interface Binder extends UiBinder<Widget, Below> {
    }
    ...
    public void run() {
        ...
        listBox = DropdownPositionTestHelper.buildSample(DropdownPosition.BELOW, null, null);
