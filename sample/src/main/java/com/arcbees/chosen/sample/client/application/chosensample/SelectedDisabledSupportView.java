...
public class SelectedDisabledSupportView implements IsWidget {
    interface Binder extends UiBinder<Widget, SelectedDisabledSupportView> {
    }
    ...
    public SelectedDisabledSupportView() {
